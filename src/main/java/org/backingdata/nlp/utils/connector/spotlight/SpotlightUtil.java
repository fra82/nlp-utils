...
public class SpotlightUtil {
	 ...
	 * @return
	 */
	public static Map<String, String> spotEntitiesByType(String text, Integer timeourInSecods, String URLencodedTypes) {
		...
		if(waitTimeAfterRequestInSeconds != null && waitTimeAfterRequestInSeconds > 0) {
			try {
				Thread.sleep(waitTimeAfterRequestInSeconds * 1000);
